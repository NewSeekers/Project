...
<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
        ...
        <head>
            ...
            <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.1/di
st/css/bootstrap.min.css" rel="stylesheet"
        ...
        <body>
            ...
            <div id="carousel1" class="carousel carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active" data-bs-interval="2000">
                        <img src="<c:url value='./img/carousel1.jpg'/>" class="d-block w-100" alt="...">
                        <a href="./seoul_main.jsp"><button type="button" class="btn1 btn-outline-dark"> 바로가기
                            </button></a>

                    </div>
                    <div class="carousel-item">
                        <img src="<c:url value='./img/carousel2.jpg'/>" class="d-block w-100" alt="...">
                        <a href="./gu_page.jsp"><button type="button" class="btn1 btn-outline-dark"> 바로가기 </button></a>

                    </div>
                    <div class="carousel-item">
                        <img src="<c:url value='./img/carousel3.jpg'/>" class="d-block w-100" alt="...">
                ...
                <div class="row">
                    <div class="intro1 col-md-6 px-5">
                        ...
                        <a href="./seoul_main.jsp">
                            <img class="img-fluid mb-4" src="<c:url value='./img/siteimg.png'/>" alt="">
                        </a>
                    </div>
                            ...
                            <div class="table-responsive">
                                ...
                                <div id="j_board_list">
                                    ...
                                    <table id="board-table" class=" table table-bordered table-condensed table-hover">
                                        <thead>
                                            <tr class="success">
                                                <th class="num"><a href="/newseekers/board/list?page=1">No</a></th>
                                                <th class="title"><a href="/newseekers/board/list?page=1">제목</a></th>
                                                <th class="writer"><a href="/newseekers/board/list?page=1">작성자</a></th>
                                                <th class="date"><a href="/newseekers/board/list?page=1">작성일</a></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                ...
                <div id="safetyMenu">
                    <div id="safetyMenu1">
                        <div class="wow fadeInUp" data-wow-delay="0.3s">
                            <div class="icon">
                                <img src="<c:url value='./img/icon1.PNG'/>" alt="">
                            </div>
                        ...
                        <div class="wow fadeInUp" data-wow-delay="0.8s">
                            <div class="icon">
                                <img src="<c:url value='./img/icon2.PNG'/>" alt="">
                            </div>
                            <div class="icon_ment1">어두운 길피하기</div>
                            <div class="icon_ment2">어두운 밤,<br>시야가 확보되지않은 상황에<br>어두운 길을 걷는것은 위험합니다.<br>가로등이나 밝은 상가가<br>많은
                                거리를
                                걷는것이<br>안전에 도움이 됩니다.
                            </div>
                        </div>
                    ...
                    <div id="safetyMenu2">
                        <div class="wow fadeInUp" data-wow-delay="1.3s">
                            <div class="icon">
                                <img src="<c:url value='./img/icon3.PNG'/>" alt="">
                            </div>
                            <div class="icon_ment1">걸어다닐때<br> 핸드폰하지않기
                            </div>
                            <div class="icon_ment2"> 생활의 편리를 제공해주는<br>스마트 폰이지만<br>안전사고로<br>위험해 질 수 있는 스마트폰!<br>보행중에는
                                스마트폰을
                                사용을<br>지양시길
                                당부드립니다.
                        ...
                        <div class="wow fadeInUp" data-wow-delay="1.8s">
                            <div class="icon">
                                <img src="<c:url value='./img/icon4.PNG'/>" alt="">
                            </div>
            ...
            <!-- 모달 창 부분 -->
            <div class="modal fade" id="myPageModal" tabindex="10" aria-labelledby="ModalLabel" aria-hidden="true">
