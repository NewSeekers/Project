	...
	<body>
		...
		<div class="container-fluid">
			<div class="totalbox">
				...
				<div id="modalContainer">
					<span id="exp1_1">다중선형 회귀분석이란</span> <img src="./img/ques.png" id="exp_img">
					<div id="modalContent">
					...
					<div class="box-1">
						<div class="btn-group dropend">
							<button type="button" class="btn btn-success btn-sm dropdown-toggle" data-bs-title="자치구"
								data-bs-toggle="dropdown" aria-expanded="false" id=guDropdown>자치구 선택</button>
						...
						<div class="box-1-gu">
							...
							<ul class="col-sm-6 col-md-6 rank-people">
								<li><span id="rank-text"> &nbsp;&nbsp;안전등급:</span><span id="grade">0</span></li>
								<br>
								<li><span id="people"> &nbsp;&nbsp;인구수:</span><span id="population">0</span></li>
							</ul>
						</div>
					</div>
							...
							<div class="row" id="crBox-1">
								<div class="crBox" data-condition="0" id="crimeReason1" style="display: none">
									...
									<div class="btnWrap tooltip-container1">
										<input type="button" class="btn btn-sm btn-info btnplus" value="+"
											style="width: 30px;">&nbsp;&nbsp;&nbsp; <input type="button"
											class="btn btn-sm btn-info btnminus" value="-" style="width: 30px;">
									</div>
								</div>
		...
		<div id="sidebar">
			...
			<a href="#chartTitle" id="rankIcon" data-bs-toggle="tooltip" data-bs-placement="right" title="범죄율 변화"
				data-bs-custom-class="custom-tooltip" class="fa-solid fa-chart-column"></a> <a href="#text"
				id="siteIcon" data-bs-toggle="tooltip" data-bs-placement="right" title="우리동네 공원찾기"
