			...
			<body>
				...
				<div id="j_board_list_wrap">
					<div id="j_board_list">
						...
						<c:forEach items="${list}" var="dto">
							<ul>
								...
								<li class="j_list_title">
									<c:forEach begin="1" end="${dto.bIndent}">--</c:forEach> <a
					...
					<div id="j_board_page">
						...
						<ul class="pagination">
							<li><a href="#" class="j_bt first"> <- </a> <a href="#" class="j_bt prev"> / </a> <a
											href="#" class="j_num on">1</a> <a href="#" class="j_num">2</a> <a href="#"
											class="j_num">3</a> <a href="#" class="j_num">4</a> <a href="#"
											class="j_num">5</a> <a href="#" class="j_bt next"> ></a> <a href="#"
											class="j_bt last">
											>></a></li>
						</ul>
