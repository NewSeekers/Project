			...
			<div class="board_wrap">
				...
				<div class="board_list_wrap">
					...
					<div class="board_page">
						...
						<a href="list.do?page=1" class="bt first">
							<< </a> <a href="list.do?page=${currentPage - 1}" class="bt prev">
									< </a>


										<c:forEach var="pageNumber" begin="${startPage}" end="${endPage}">
											<c:set var="onClass" value="${pageNumber eq currentPage ? 'on' : ''}" />
											<a href="list.do?page=${pageNumber}"
												class="num ${onClass}">${pageNumber}</a>
										</c:forEach>
