...
<link
	...
	<!--fontawsome icon-->
<script src="https://kit.fontawesome.com/2a2ce3b1ad.js"
...
<body>
	...
	<div class="container-fluid">
		<div class="row" id="map_box">
			...
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-2 col-xl-1"
				id="gradeBox">
				...
				<div class="row gx-5" id="s_grade">
					...
					<div class="col-2 col-sm-2 col-md-2 col-lg-12">
						<button id="btn6" type="button" class="btn btn-lg" value="1"
							onclick="displayAllArea()">
							<h5>전체등급</h5>
						</button>
					</div>
				</div>
			...
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-10 col-xl-10">
				...
				<div id="adjYear">
					<div id="s_slide">
						<div>
							<input id="slider" class="slider" type="range" min="2004"
								max="2022" value="2022" step="3" list="tickmarks">
						</div>
						<div id="output"></div>
						<div>
							<span id="question1">&nbsp;&nbsp;<i
								...
								<div id="modalContainer1" class="hidden">
									<div id="modalContent1">
										...
										<br>
										<h6>
											◎ 인구 만명당 5대주요범죄 발생건수(-) : 50%<br>
											<br> ◎ 인구 만명당 경찰관서 수(+) : 20% 
											<br>
											<br> ◎ 인구 만명당 범죄예방CCTV 수(+) : 10% 
											<br>
											<br> ◎ 인구 만명당 방범등 수(+) : 10% 
											<br>
											<br> ◎ 인구 만명당 주점 수(-) : 10% 
	...
	<div id="sidebar">
		...
		<a href="#chartBox" id="chartIcon" data-bs-toggle="tooltip"
			data-bs-placement="right" title="차트로 보는 서울"
			data-bs-custom-class="custom-tooltip"
			class="fa-solid fa-chart-simple"></a> <a href="#secuRank"
			id="rankIcon" data-bs-toggle="tooltip" data-bs-placement="right"
			title="사회 안전 지수" data-bs-custom-class="custom-tooltip"
			class="fa-solid fa-ranking-star"></a>
	</div>
