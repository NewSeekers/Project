    ...
    <body>
                    ...
                    <div class="row gx-5" id="s_grade">
                        <div class="col-2 col-sm-2 col-md-2 col-lg-12">
                            <button id="btn1" type="button" class="btn btn-lg " value="1"
                                style="color: rgb(39, 39, 39); background-color: #f9ddb1;" onclick="gradeSelec('btn1')">
                                <h6>1 등급</h6>
                            </button>
                        </div>
                        <div class="col-2 col-sm-2 col-md-2 col-lg-12">
                            <button id="btn2" type="button" class="btn btn-lg " value="2"
                                style="color: rgb(39, 39, 39); background-color: #f5c77e;" onclick="gradeSelec('btn2')">
                                <h6>2등급</h6>
                            </button>
                        </div>
                        <div class="col-2 col-sm-2 col-md-2 col-lg-12">
                            <button id="btn3" type="button" class="btn btn-lg " value="3"
                                style="color: rgb(39, 39, 39); background-color: #f1b04c;" onclick="gradeSelec('btn3')">
                                <h6>3등급</h6>
                            </button>
                        </div>
                        <div class="col-2 col-sm-2 col-md-2 col-lg-12">
                            <button id="btn4" type="button" class="btn btn-lg " value="4"
                                style="color: rgb(39, 39, 39); background-color: #ee9f27;" onclick="gradeSelec('btn4')">
                                <h6>4등급</h6>
                            </button>
                        </div>
                        <div class="col-2 col-sm-2 col-md-2 col-lg-12">
                            <button id="btn5" type="button" class="btn btn-lg " value="5"
                                style="color: rgb(39, 39, 39); background-color: #ec9006;" onclick="gradeSelec('btn5')">
                                <h6>5등급</h6>
                            </button>
                        </div>
                        <div class="col-2 col-sm-2 col-md-2 col-lg-12">
                                ...
                                <span id="question1">&nbsp;&nbsp;<i class="fa-solid fa-question">&nbsp;&nbsp;</i>
                                    <div id="modalContainer1" class="hidden">
                                        <div id="modalContent1">
                                            <p>
                                            <h5>안전등급산정기준</h5><br>
                                            <h6>◎ 인구 만명당 5대주요범죄 발생건수(-) : 50%<br><br>
                                                ◎ 인구 만명당 경찰관서 수(+) : 20%<br><br>
                                                ◎ 인구 만명당 범죄예방CCTV 수(+) : 10%<br><br>
                                                ◎ 인구 만명당 방범등 수(+) : 10%<br><br>
                                                ◎ 인구 만명당 주점 수(-) : 10%<br><br>
                                            </h6>
                                            </p>
                                        </div>
                                    </div>
        ...
        <div class="container-fluid rankContainer">
            ...
            <div class="row" id="secuRank">
                ...
                <div class="col-sm-12 col-lg-5 secuContent">
                    <br><br>
                    <h4>사회안전지수</h4><br>
                    <h6>성신여대 데이터 사이언스 센터, 여론조사기관 케이스탯리서치,<br><br>온라인패널 조사기업 피앰아이와 공동으로<br><br>'사회안전지수(Korea Security
                        Index)'를
                        2021년부터 발표하고 있다.<br><br>조사대상은 기초지방자치단체 중 표본의 숫자가 적은 곳을 제외한<br><br>155개 시, 군, 구이며 매년 정기적으로
                        사회안전지수를 발표할 계획이다.
                    </h6>
                    <br>
                    <h4>체감안전도</h4><br>
                    <h6>1년에 2번씩 각 지방청에서 전국 단위로 200여개<br><br>경찰서 단위로 경찰서 당 200명씩 상,하반기에 체감안전도 설문조사<br><br>전화, 모바일을 통해
                        설문조사를
                        실시하고 있으며,<br><br>
                        범죄로부터 얼마나 안전한지 유형별로 분류하고있다.
        ...
        <div id="sidebar">
            ...
            <a href="#chartBox" id="chartIcon" data-bs-toggle="tooltip" data-bs-placement="right" title="차트로 보는 서울"
                data-bs-custom-class="custom-tooltip" class="fa-solid fa-chart-simple"></a>
            <a href="#secuRank" id="rankIcon" data-bs-toggle="tooltip" data-bs-placement="right" title="사회 안전 지수"
