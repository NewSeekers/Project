...
var gradeColors = [['#f9ddb1', '#f5c77e', '#f1b04c', '#ee9f27', '#ec9006'], //2004년//
...
['#aaf2ef', '#75e9e5', '#00d5d6', '#00bdd0', '#00a0b7']] //2022년//
...
function displayArea(area) {
    ...
    var polygon = new kakao.maps.Polygon({
        ...
        strokeColor: '#004c80',
        strokeOpacity: 0.8,
        fillColor: gradeColors[(parseInt(currentValue) - 2001) / 3 - 1][area.guGrade[((parseInt(currentValue) - 2001) / 3) - 1] - 1],
        fillOpacity: 0.7
    ...
    kakao.maps.event.addListener(polygon, 'mouseover', function (mouseEvent) {
        ...
        customOverlay.setContent('<div class="area">' + '<h5>' + area.guName + '</h5><br>' + '<h6>안전등급 : ' + area.guGrade[((parseInt(currentValue) - 2001) / 3) - 1] + '</h6>' + '</div>');
    ...
    kakao.maps.event.addListener(polygon, 'mouseout', function () {
        polygon.setOptions({ fillColor: gradeColors[(parseInt(currentValue) - 2001) / 3 - 1][area.guGrade[((parseInt(currentValue) - 2001) / 3) - 1] - 1] });
...
var homicideYear = ['229', '221', '293', '159', '152', '146', '127']; //연도별 살인 수
var robberYear = ['1631', '1088', '1026', '433', '261', '149', '129']; // 연도별 강도 수
var sexcrimeYear = ['3110', '3577', '5671', '7396', '8390', '9206', '8192'] //연도별 성범죄 수
var theftYear = ['36097', '30039', '49085', '63722', '46972', '42338', '33609'] //연도별 절도 수
var violenceYear = ['6468', '32438', '32964', '34795', '40732', '33921', '23891'] // 연도별 폭행 수
...
function crimeyear(currentValue) {
    return crimeYearArr = [homicideYear[(parseInt(currentValue) - 2001) / 3 - 1],
    robberYear[(parseInt(currentValue) - 2001) / 3 - 1],
    sexcrimeYear[(parseInt(currentValue) - 2001) / 3 - 1],
...
slider.addEventListener('input', function () {
    ...
    document.getElementById('chartTitle1').innerHTML = currentValue + "년 범죄비율";
    document.getElementById('chartTitle2').innerHTML = currentValue + "년 범죄 발생수";

    document.getElementById('btn1').style.backgroundColor = gradeColors[(parseInt(currentValue) - 2001) / 3 - 1][document.getElementById('btn1').value - 1];
    document.getElementById('btn2').style.backgroundColor = gradeColors[(parseInt(currentValue) - 2001) / 3 - 1][document.getElementById('btn2').value - 1];
    document.getElementById('btn3').style.backgroundColor = gradeColors[(parseInt(currentValue) - 2001) / 3 - 1][document.getElementById('btn3').value - 1];
    document.getElementById('btn4').style.backgroundColor = gradeColors[(parseInt(currentValue) - 2001) / 3 - 1][document.getElementById('btn4').value - 1];
    document.getElementById('btn5').style.backgroundColor = gradeColors[(parseInt(currentValue) - 2001) / 3 - 1][document.getElementById('btn5').value - 1];

    document.getElementById('cctvNum').innerText = cctvCount[(parseInt(currentValue) - 2001) / 3 - 1];
    document.getElementById('lightNum').innerText = lightCount[(parseInt(currentValue) - 2001) / 3 - 1];
    document.getElementById('policeNum').innerText = policeCount[(parseInt(currentValue) - 2001) / 3 - 1];

    document.getElementById('cctvNumHead').style.backgroundColor = gradeColors[(parseInt(currentValue) - 2001) / 3 - 1][0];
    document.getElementById('lightNumHead').style.backgroundColor = gradeColors[(parseInt(currentValue) - 2001) / 3 - 1][0];
    document.getElementById('policeNumHead').style.backgroundColor = gradeColors[(parseInt(currentValue) - 2001) / 3 - 1][0];
...
homicideYear = ['229', '221', '293', '159', '152', '146', '127']; //연도별 살인 수
robberYear = ['1631', '1088', '1026', '433', '261', '149', '129']; // 연도별 강도 수
sexcrimeYear = ['3110', '3577', '5671', '7396', '8390', '9206', '8192'] //연도별 성범죄 수
theftYear = ['36097', '30039', '49085', '63722', '46972', '42338', '33609'] //연도별 절도 수
violenceYear = ['6468', '32438', '32964', '34795', '40732', '33921', '23891'] // 연도별 폭행 수
...
function yearCrime(currentValue) {
    return crime = [homicideYear[(parseInt(currentValue) - 2001) / 3 - 1],
    robberYear[(parseInt(currentValue) - 2001) / 3 - 1],
    sexcrimeYear[(parseInt(currentValue) - 2001) / 3 - 1],
    theftYear[(parseInt(currentValue) - 2001) / 3 - 1],
    violenceYear[(parseInt(currentValue) - 2001) / 3 - 1]];
